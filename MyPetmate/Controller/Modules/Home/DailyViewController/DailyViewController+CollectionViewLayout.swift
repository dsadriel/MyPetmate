...
extension DailyViewController {
    func buildPetSelectorLayout(visibleItemsInvalidationHandler: @escaping  ([any NSCollectionLayoutVisibleItem], CGPoint, any NSCollectionLayoutEnvironment) -> Void ) -> Layout {
